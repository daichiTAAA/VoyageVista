...
async def create_cultural_insight(
    ...
    try:
        ...
        return schemas.CulturalInsight(**db_cultural_insight.__dict__)
    except Exception as e:
...
async def delete_cultural_insight(db: AsyncSession, cultural_insight_id: int) -> bool:
